...
func (s *BaseSSQLListener) EnterFrom(ctx *FromContext) {}

// ExitFrom is called when production from is exited.
func (s *BaseSSQLListener) ExitFrom(ctx *FromContext) {}
...
func (s *BaseSSQLListener) EnterIsnull(ctx *IsnullContext) {}

// ExitIsnull is called when production isnull is exited.
func (s *BaseSSQLListener) ExitIsnull(ctx *IsnullContext) {}

// EnterBoolean is called when production boolean is entered.
func (s *BaseSSQLListener) EnterBoolean(ctx *BooleanContext) {}

// ExitBoolean is called when production boolean is exited.
func (s *BaseSSQLListener) ExitBoolean(ctx *BooleanContext) {}
