...
func (v *BaseSSQLVisitor) VisitFrom(ctx *FromContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseSSQLVisitor) VisitIsnull(ctx *IsnullContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseSSQLVisitor) VisitBoolean(ctx *BooleanContext) interface{} {
	return v.VisitChildren(ctx)
}
